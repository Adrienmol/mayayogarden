const translations = {
    "es": {
        "title" : "Mayayo Garden - Centro de Jardinería",
        "nav-home": "Inicio",
        ...
        "services-plant-description": "Contamos con una gran variedad de plantas en nuestro invernadero. También contamos con arbolado, frutales y palmeras.",
        "services-article-header": "Artículos de Jardinería",
        "services-article-description": "Herramientas, abono, maceteros, productos para sanear tus plantas, herramientas para riego y mucho más.",
    ...
    "en": {
        "title" : "Mayayo Garden - Gardening Center",
        "nav-home": "Home",
        ...
        "services-plant-description": "We have a wide variety of plants in our greenhouse. We also have trees, fruit trees, and palm trees.",
        "services-article-header": "Gardening Articles",
        "services-article-description": "Tools, fertilizer, planters, products to keep your plants healthy, irrigation tools, and much more.",
...
function translate(language) {
    ...
    document.getElementById('services-article-header').textContent = translation['services-article-header'];
    document.getElementById('services-article-description').textContent = translation['services-article-description'];
